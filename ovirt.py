...
parser.add_option("-a", "--adddisk", dest="adddisk", metavar="DISKSIZE",type="int", help="Specify Disk size,in Go to add")
...
parser.add_option("-d", "--disk", dest="disksize2", metavar="DISKSIZE",type="int", help="Specify Disk size,in Go at VM creation")
...
parser.add_option("-m", "--memory", dest="memory2", metavar="MEMORY",type="int", help="Specify Memory, in Mo")
...
parser.add_option("-v", "--reset", dest="reset", action="store_true", help="Reset kernel parameters for given VM")
...
parser.add_option("-E", "--cluster", dest="clu", metavar="CLUSTER",type="string", help="Specify Cluster")
