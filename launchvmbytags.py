...
parser.add_option("-t", "--tag", dest="tag",type="string", default="first_install",help="Tag to use to find vms")
parser.add_option("-l", "--listclients", dest="listclients",action="store_true", help="List Available Clients")
parser.add_option("-i", "--insecure", dest="insecure",default=False,action="store_true", help="Connect without ssl")
